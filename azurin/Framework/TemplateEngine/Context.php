...
class Context
{
    ...
    public function __construct($context = null, $options = [])
    {
        ...
        if (isset($options[TemplateEngine::OPTION_ENABLE_DATA_VARIABLES])) {
            if (!is_bool($options[TemplateEngine::OPTION_ENABLE_DATA_VARIABLES])) {
                throw new InvalidArgumentException(
                    'Context Constructor "' . TemplateEngine::OPTION_ENABLE_DATA_VARIABLES . '" option must be a boolean'
                );
            }
            $this->enableDataVariables = $options[TemplateEngine::OPTION_ENABLE_DATA_VARIABLES];
        }
    }
