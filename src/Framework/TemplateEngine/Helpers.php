...
class Helpers
{
     ...
     * {{/if}}
     *
     * @param \TemplateEngine\Template $template template that is being rendered
     * @param \TemplateEngine\Context  $context  context object
     ...
     * @param \TemplateEngine\Template $template
     * @param \TemplateEngine\Context $context
     * @return string
     */
