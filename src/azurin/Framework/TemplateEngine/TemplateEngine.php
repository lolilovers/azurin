...
use Azurin\Framework\TemplateEngine\Loader\StringLoader;
use Azurin\Framework\TemplateEngine\Cache\Dummy;
...
class TemplateEngine
{
    ...
    /**
     * TemplateEngine engine constructor
    ...
    public function __construct(Array $options = [])
    {
        ...
        if (isset($options['escape'])) {
            if (!is_callable($options['escape'])) {
                throw new InvalidArgumentException(
                    'TemplateEngine Constructor "escape" option must be callable'
                );
            }
        ...
        if (isset($options[self::OPTION_ENABLE_DATA_VARIABLES])) {
            if (!is_bool($options[self::OPTION_ENABLE_DATA_VARIABLES])) {
                throw new InvalidArgumentException(
                    'TemplateEngine Constructor "' . self::OPTION_ENABLE_DATA_VARIABLES . '" option must be a boolean'
                );
            }
     ...
     *
     * Equivalent to calling `$TemplateEngine->loadTemplate($template)->render($data);`
     *
     ...
     *
     * @param Helpers $helpers TemplateEngine helper
     *
     * @return void
     */
     ...
     * Set current loader
     *
     * @param Loader $loader TemplateEngine loader
     * @return void
     */
     ...
     *
     * @param Cache $cache TemplateEngine cache
     * @return void
     */
    ...
    /**
     * Set the TemplateEngine Tokenizer instance.
     *
    ...
    /**
     * Get the current TemplateEngine Tokenizer instance.
     *
    ...
    /**
     * Set the TemplateEngine Parser instance.
     *
    ...
    /**
     * Get the current TemplateEngine Parser instance.
     *
     ...
     *
     * @param string $source TemplateEngine source code
     * @return array TemplateEngine parsed data into array
     */
